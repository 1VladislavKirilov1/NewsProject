...
<h3>Для того, чтобы запустить код достаточно загрузить себе на компьютер данный репозиторий, затем выполнить команды:<br>
  ...
  <h3>UPD 10.07: Было добавлено приложение "deletenews", которое удаляет все новости из выбранной категории.<br> Для использования достаточно ввести в терминале python manage.py delete news <название категории большими буквами> <br> Доступный список категорий на данный момент:<br> SPORT <br> IT <br> MUSIC <br> AUTO <br> NATURE <br> POLITICS</h3>
